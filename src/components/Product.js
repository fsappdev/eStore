   ...
   render() {
      ...
      return (
         <ProductWrapper className="col-9 mx-auto col-md-6 col-lg-3 my-3">
            <div className="card">
               <div className="img-container p-5" onClick={() => console.log('me haz clickeado en el contenedor de imagen')}>
                  <Link to='/details'>
                  ...
                  <button className="cart-btn" disabled={inCart ? true : false} onClick={() => { console.log('agregado al carrito'); }}>
                     {inCart ? (<p className="text-capitalize mb-0" disabled>Agregado al carrito</p>) : (<i className="fas fa-cart-plus" />)}
                  </button>
               </div>
